...
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-m32', '-g', '-O3', '-msse2', '-ffast-math']
CXXFLAGS_DEBUG = ['-g']
...
LIBDIR = '/home/klenzel/.node_libraries'
LIBPATH_NODE = '/usr/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS = ['-m32']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/lib/colorgcc/bin/g++']
NODE_PATH = '/home/klenzel/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr'
